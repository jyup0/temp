...
def CleanResults(rule):
    ...
    for file in os.listdir(DirRPath):
        ...
        predefined_topics = ['Communication Methods / Proof of Communication', '36-Hour Notice Period', 'Computer Security Incident Actual/Potential Standard',
                           ...
                           'Proposed Rule Duplicative/Unnessecary', 'Service Provider Notification of 2 People', 'Good Standing reporting standard']
    
        # Preprocess document
        document = " ".join([preprocess_text(row) for row in df])
        ...
        print(file)
        print("Matching Topics:", matching_topics)
